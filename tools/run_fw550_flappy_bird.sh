...
pinned_eden_sha256=f3bff16b9977820d5391c59088751f7a5c829e451f511102aa79ccd5cbcc0946
...
VULKAN_PS5_QUALIFICATION_REQUIRED_PATTERN_6='Prospero Dynarmic memory path: core=0 sparse_callbacks=true single_lookup_scalars=true checked_width_scalars=true scalar_page_cache=true scalar_cache_storage=core-indexed scalar_cache_hit_inline=true fastmem=false address_space_bits=39' \
