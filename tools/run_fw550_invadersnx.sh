...
homebrew=${EDEN_PS5_INVADERSNX_NRO:-$repo_dir/../InvadersNX.nro}
sidecar="$repo_dir/src/ps5/eden-invadersnx.launch"
pinned_eden_sha256=3b22a7cea17af3fd300dc8d5e8d8160b5bba592fbeeef18cb1b4aa2b83716c2e
...
sidecar_sha256=182bbf2e1cf750ffe5b068bc60473eb44ba47e800704a761a5dfe8db122a06e2
homebrew_sha256=4ad1a05d7e7edba203d086151bf83d2be02bf2ead8695ce4d21f21b4bdf27433
...
while [ "$run" -le 2 ]; do
    ...
    VULKAN_PS5_QUALIFICATION_LABEL="eden-invadersnx-run${run}" \
    VULKAN_PS5_QUALIFICATION_PASS_PATTERN='^eden-ps5: GAME PASS 600 frames$' \
    VULKAN_PS5_QUALIFICATION_PASS_DESCRIPTION='InvadersNX homebrew, 600 presented frames, and bounded teardown' \
    ...
    VULKAN_PS5_QUALIFICATION_ASSET_REMOTE_NAME=InvadersNX.nro \
...
echo "eden-ps5 FW 5.50 InvadersNX immediate-relaunch gate: PASS"
